...
const fetchAndDisplayCompanies = async () => {
 ...
 class="schedule-btn  bg-white text-green-500 font-bold py-2 px-4 rounded-full shadow-md border-1 border-green-500 over:text-white hover:bg-green-600 transition-colors duration-200" >スケジュール</button>
